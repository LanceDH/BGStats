...
local _type = "Atrifact Fragments"
local info = "Amount of artifact fragments on this character"
...
function TrackerClass.new(name, id, save)
  local self = setmetatable({}, TrackerClass)
	...
	self.icon = "Interface\\ICONS\\inv_ashran_artifact"
	self.info = "Amount of artifact fragments on this character"
	self.options = {}
	self.frameNr = id
	self.visipos = -1
	self.colSpan = 1
...
function TrackerClass:UpdateFragmentInfo()
	self.frame.text:SetText(BGS_TrackerClasses:GetArtifactFragments())
end
