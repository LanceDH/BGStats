...
local TrackerClass = {}
TrackerClass.name = "FragmentFrame"
TrackerClass.detail = "Artifact Fragments"
TrackerClass.icon = "Interface\\ICONS\\inv_ashran_artifact"
TrackerClass.info = "Amount of artifact fragments on this character"
...
local function UpdateFragmentInfo()
	local ScoreFrame = BGS_TrackerClasses:GetFrameByName(TrackerClass.name)
	ScoreFrame.text:SetText(BGS_TrackerClasses:GetArtifactFragments())
end
