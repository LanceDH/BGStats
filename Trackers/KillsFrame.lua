...
local _type = "Honorable Kills"
local info = "Honorable kills for this character"
...
function TrackerClass.new(name, id, save)
  local self = setmetatable({}, TrackerClass)
	...
	self.icon = "Interface\\ICONS\\INV_MISC_BONE_HUMANSKULL_02"
	self.info = "Honorable kills for this character."
	self.options = {}
	self.frameNr = id
	self.visipos = -1
	self.colSpan = 1
...
function TrackerClass:UpdateKillsInfo()
	self.frame.text:SetText(BGS_TrackerClasses:GetHKills())
end
