...
local TrackerClass = {}
TrackerClass.name = "TBFrame"
TrackerClass.detail = "Tol Barad"
TrackerClass.icon = "Interface\\ICONS\\Achievement_Zone_Tolbarad"
TrackerClass.info = "Amount of Tol Barad tokens on this character"
...
local function UpdateTBInfo()
	local ScoreFrame = BGS_TrackerClasses:GetFrameByName(TrackerClass.name)
	ScoreFrame.text:SetText(BGS_TrackerClasses:GetTB())
end
